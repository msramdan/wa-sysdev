      ...
      <header class="common-header">
        <div class="common-header-start">
          <button class="u-flex js-user-nav">
            <img class="profile-image" src="../img/logo2.png" alt="">
            <div class="common-header-content">
              <h1 class="common-header-title">Saya</h1>
            </div>
          </button>
        </div>
      ...
      <header class="common-header">
        <div class="common-header-start">
          ...
          <button class="u-flex js-side-info-button">
            <img class="profile-image" src="../img/logo2.png">
            <div class="common-header-content">
              <h2 class="common-header-title nama-container">MsRamdan</h2>
    ...
    <aside class="main-info u-hide">
      ...
      <div class="main-info-content">
        <section class="common-box">
          <img class="main-info-image" src="../img/logo2.png" alt="">
